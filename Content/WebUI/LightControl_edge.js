...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'RedRect',
                type: 'rect',
                rect: ['34px', '54px','58px','220px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'none',
                type: 'rect',
                rect: ['453px', '54px','58px','220px','auto', 'auto'],
                overflow: 'visible',
                borderRadius: ["10px", "10px", "10px", "10px"],
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid10", tween: [ "style", "${_GreenRect}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 }            ]
        }
    }
},
"MainMenuButton_S": {
